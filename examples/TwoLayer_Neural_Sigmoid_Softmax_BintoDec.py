...
class TwoLayer_Neural_Sigmoid_Softmax_BintoDec:
    def __init__(self, hiddenLayerSize = 4,numbTrainIterations = 10000):
    ...
    def predict(self,X):
        ...
        self.norm_scores = sm.softmax_get_normalized_scores(self.l1,self.W1)
    ...
    def fit(self,X,y):
        ...
        for j in range (self.numbTrainIterations):
            ...
            if j%rowskip == 0:
                self.loss.append(sm.softmax_get_data_loss(self.norm_scores, num_train, y))
